class Game {
    // whenever you building a class base object you'd want to use a constuctor
    constructor() {
    ...
    playerChange() {
        this.currentPlayer = this.currentPlayer === "X" ? "O" : "X" // ternary operator shortens up and "if else"
        this.currPlayerTurn()
    }
